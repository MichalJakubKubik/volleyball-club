...
namespace MyApplication.Migrations
{
    ...
    [Migration("20230420192000_StaffAdj")]
    partial class StaffAdj
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyApplication.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ManagingClubId")
                        .IsUnique()
                        .HasFilter("[ManagingClubId] IS NOT NULL");
            ...
            modelBuilder.Entity("MyApplication.Entities.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyApplication.Entities.User", b =>
                {
                    b.HasOne("MyApplication.Entities.Club", "ManagingClub")
                        .WithOne("ManagingUser")
                        .HasForeignKey("MyApplication.Entities.User", "ManagingClubId");

                    b.HasOne("MyApplication.Entities.UserRole", "UserRole")
                        .WithMany("Users")
                        .HasForeignKey("UserRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ManagingClub");
